...
public class ErrorReport {
	...
	public static ErrorReport withException(String cause, Throwable error) {
		...
		Plugin pexPluginInstance = Bukkit.getPluginManager().getPlugin("PermissionsEx");
		SpigotPermissionsExPlugin pexPlugin = pexPluginInstance instanceof SpigotPermissionsExPlugin
				? (SpigotPermissionsExPlugin) pexPluginInstance
				: null;
